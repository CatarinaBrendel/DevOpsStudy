...
import { Search, Funnel, ArrowRepeat, HddStack } from "react-bootstrap-icons"; // Bootstrap Icons
...
export default function EmptyServerState({
    ...
    return(
        <div className="position-realtive w-100 h-100"
            style={{background: "radial-gradient(circle at 1px 1px, color-mix(in oklab, var(--bs-primary) 16%, transparent), transparent 2px) 0 0/24px 24px"}}
        >
            <div className="d-flex alugn-items-center justify-content-center h-100 p-3">
                <div className="card shadow-lg border-0">
                    <div className="card-body p-4 p-md-5 text-center">
                        <div className="mx-auto mb-3 d-inline-flex align-items-center justify-content-center rounded-circle border" style={{width: 96, height: 96, borderColor: "#e9ecef", background: "#fff"}}>
...
function Tip({ icon, title, desc }) {
  return (
    ...
    >
      <div
        className="d-inline-flex align-items-center justify-content-center rounded-2 border border-primary-subtle bg-primary-subtle text-primary"
